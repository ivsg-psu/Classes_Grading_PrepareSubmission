...
%
%       script_demo_PrepareSubmission.m
%
% This is a script to demonstrate the functions within the PrepareSubmission code
% library. This code repo is typically located at:
%
%   https://github.com/ivsg-psu/Classes_Grading_PrepareSubmission
%
...
if 1==1
    clear flag_PrepareSubmission_Folders_Initialized
end
...
if ~exist('flag_PrepareSubmission_Folders_Initialized','var')
    ...
    flag_PrepareSubmission_Folders_Initialized = 1;
end
...
setenv('MATLABFLAG_PREPARESUBMISSION_FLAG_CHECK_INPUTS','1');
setenv('MATLABFLAG_PREPARESUBMISSION_FLAG_DO_DEBUG','0');
