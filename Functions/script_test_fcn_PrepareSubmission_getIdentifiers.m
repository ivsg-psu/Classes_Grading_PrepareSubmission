% script_test_fcn_PrepareSubmission_getIdentifiers.m
% tests fcn_PrepareSubmission_getIdentifiers.m
...
%%%%%%%%%%
% Call the function
identifiers = fcn_PrepareSubmission_getIdentifiers((figNum));
...
assert(isequal(size(identifiers),[1 1]));
...
%%%%%%%%%%
% Call the function
identifiers = fcn_PrepareSubmission_getIdentifiers(([]));
